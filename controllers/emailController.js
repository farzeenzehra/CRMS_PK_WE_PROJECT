...
var transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
        user: "theuniversityportal@gmail.com",
        pass: "syaoktjxwughnprf"
    },
    tls: {
...
function sendOTPEmail(req, res) {
    ...
    let fullname = res.locals.fullname;
...
<body style="background-color: #020739;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Forgot your password? Here is your OTP . . . .
  </div>
  <!-- end preheader -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://crmspk.azurewebsites.net/" target="_blank" style="display: inline-block;">
                <img src="https://i.ibb.co/KGQJCTs/logo-Nname.png" alt="Logo" border="0"style="display: block; ">
              </a>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Hi ${fullname}!<br><br>Use the code below to reset your account password. If you didn't request a new password, you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end copy -->
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
              <p style="margin: 0;">Regards,<br> CRMS</p>
            </td>
          </tr>
          <!-- end copy -->
  ...
  <!-- end body -->
    ...
    var mailOptions = {
        from: "CRMS <theuniversityportal@gmail.com>",
        to: `"${fullname}" <${email}>`,
...
function sendVerificationEmail(usern, pass, vCode, fullname, email) {
    let htmlContent = 
    `
<!DOCTYPE html>
<html>
...
<body style="background-color: #020739;">
  ...
  <!-- start preheader -->
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Congratulations! Verify your account now to start using it. . . .
  </div>
  <!-- end preheader -->
      ...
      <td align="center" bgcolor="#020739">
        ...
        <tr>
          <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
            ...
            <p><b>Useranme:&emsp;&emsp;</b>${usern}</p>
            <p><b>Password:&emsp;&emsp;</b>${pass}</p>
        ...
        <!-- end copy -->
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;"><a href="https://crmspk.azurewebsites.net/verify?vCode=${vCode}" target="_blank">https://crmspk.azurewebsites.net/verify?vCode=${vCode}</a></p>
            </td>
          </tr>
          <!-- end copy -->
